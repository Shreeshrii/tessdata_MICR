#!/bin/bash
#./MICR-input/eng.MICR.training_text  uses Unicode codepoints
# MICR Encoding font uses A B C D instead of Unicode codepoints
# use micr.sed to convert MICR Encoding box files to use Unicode codepoints
